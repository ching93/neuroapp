# coding: utf-8
import keras
from .nn_model import format_images, load_mnist, save_model, predict_percent, load_model
...
def train(model,model_name,epochs=5,input_type="2d",batch_size=128):
    (xtrain,ytrain),(xtest,ytest)=load_mnist(load_valid=False,input_type=input_type)
